                    ...
                    while (true) {
                        try {
                            ...
                            if (tag.equals("2"))//实时数据
                            {
                                ...
                                collectTime = "20" + sTemp.substring(32, 34) + "-" + sTemp.substring(34, 36) + "-" + sTemp.substring(36, 38) + " " + sTemp.substring(38, 40) + ":" + sTemp.substring(40, 42) + ":" + sTemp.substring(42, 44);//采集时间 6
                                ...
                                dayMaxQuantityTime = sTemp.substring(52, 54) + sTemp.substring(54, 56) + sTemp.substring(56, 58) + sTemp.substring(58, 60) + sTemp.substring(60, 62) + sTemp.substring(62, 64);//日最高流量时间 6
                            ...
                            if (tag.equals("5"))//即时告警参数
                            {
                                ...
                                while (true) {
                                    ...
                                    if (dataID.equals("02")) {
                                        ...
                                        refluxWarningTime = "20" + sTemp2.substring(4, 6) + "-" + sTemp2.substring(6, 8) + "-" + sTemp2.substring(8, 10) + " " + sTemp2.substring(10, 12) + ":" + sTemp2.substring(12, 14) + ":" + sTemp2.substring(14, 16);//反流告警时间（1告警 0不告警）
                            ...
                            {
                                interMeasureStartTime = "20" + sTemp.substring(0, 2) + "-" + sTemp.substring(2, 4) + "-" + sTemp.substring(4, 6) + " " + sTemp.substring(6, 8) + ":" + sTemp.substring(8, 10) + ":" + sTemp.substring(10, 12);//间隔计量流量开始时间
                            ...
                            {
                                concentStartTime = "20" + sTemp.substring(0, 2) + "-" + sTemp.substring(2, 4) + "-" + sTemp.substring(4, 6) + " " + sTemp.substring(6, 8) + ":" + sTemp.substring(8, 10) + ":" + sTemp.substring(10, 12);//间隔计量流量开始时间
