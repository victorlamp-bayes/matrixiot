package com.victorlamp.matrixiot.service.gateway.filter.logging;
...
public class AccessLogFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        gatewayLog.setRoute(WebfluxFrameworkUtils.getGatewayRoute(exchange));
        ...
        gatewayLog.setUserIp(WebfluxFrameworkUtils.getClientIP(exchange));
