package com.victorlamp.matrixiot.service.gateway.handler;

import com.victorlamp.matrixiot.common.pojo.CommonResult;
import com.victorlamp.matrixiot.service.gateway.util.WebfluxFrameworkUtils;
...
import static com.victorlamp.matrixiot.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
...
public class GlobalExceptionHandler implements ErrorWebExceptionHandler {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        // 返回给前端
        return WebfluxFrameworkUtils.writeJSON(exchange, result);
    }
