package com.victorlamp.matrixiot.service.system.service.sms;
...
import com.victorlamp.matrixiot.service.framework.sms.core.client.SmsClient;
...
import com.victorlamp.matrixiot.service.system.mq.message.sms.SmsSendMessage;
import com.victorlamp.matrixiot.service.system.mq.producer.sms.SmsProducer;
...
public class SmsSendServiceImpl implements SmsSendService {
    ...
    SmsTemplateDO validateSmsTemplate(String templateCode) {
        // 获得短信模板。考虑到效率，从缓存中获取
        // TODO 调试用！
        SmsTemplateDO template = smsTemplateService.getSmsTemplateByCodeFromCache("test_02");
        // 短信模板不存在
        if (template == null) {
