package com.victorlamp.matrixiot.service.system.service.tenant;
...
import com.victorlamp.matrixiot.service.framework.tenant.config.TenantProperties;
...
import com.victorlamp.matrixiot.service.system.api.tenant.TenantPackageService;
...
import com.victorlamp.matrixiot.service.system.controller.tenant.vo.tenant.TenantExportReqVO;
import com.victorlamp.matrixiot.service.system.controller.tenant.vo.tenant.TenantPageReqVO;
...
import com.victorlamp.matrixiot.service.system.dao.tenant.TenantMapper;
...
import com.victorlamp.matrixiot.service.system.enums.permission.RoleCodeEnum;
import com.victorlamp.matrixiot.service.system.enums.permission.RoleTypeEnum;
import com.victorlamp.matrixiot.service.system.service.tenant.handler.TenantInfoHandler;
import com.victorlamp.matrixiot.service.system.service.tenant.handler.TenantMenuHandler;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 matrixiot.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
    ...
    public Long createTenant(TenantCreateReqVO createReqVO) {
        ...
        TenantUtils.execute(tenant.getId(), () -> {
            // 创建角色
            Long roleId = createRole(tenant.getId(), tenantPackage);
            // 创建用户，并分配角色
    ...
    private Long createRole(Long tenantId, TenantPackageDO tenantPackage) {
        // 创建角色
        log.info("创建角色");
