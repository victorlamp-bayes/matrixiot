...
import com.victorlamp.matrixiot.service.system.enums.ErrorCodeConstants;
...
public class OAuth2GrantServiceImpl implements OAuth2GrantService {
    ...
    public OAuth2AccessTokenDO grantAuthorizationCodeForAccessToken(String clientId, String code,
        ...
        if (StrUtil.isNotEmpty(state)) { // TODO: 如果传入的state为null，跳过state校验。 Grafana获取code时传入了state，但用code换AT时未携带state
