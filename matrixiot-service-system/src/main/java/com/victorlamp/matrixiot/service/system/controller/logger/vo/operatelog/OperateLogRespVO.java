package com.victorlamp.matrixiot.service.system.controller.logger.vo.operatelog;
...
public class OperateLogRespVO {
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "com.victorlamp.matrixiot.service.adminserver.UserController.save(...)")
